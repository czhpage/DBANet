...
labeled_data="labeled_10p"
unlabeled_data="unlabeled_10p"
folder="Task_"${task}"_10p/"
cps="AB"
...
python code/evaluate_Ntimes.py --task ${task} --exp ${folder}${method}${exp} --folds 2 --cps ${cps}
